...
│   └── tools/     # Vault manipulation tools (createNote, modifyNote, searchNotes, searchFiles, listFiles, getFileInfo, organizeNotes, readFile, editFile, writeFile, createFolder, deleteFile, moveFile, pathUtils, protected)
